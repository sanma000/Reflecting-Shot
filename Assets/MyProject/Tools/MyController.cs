...
namespace Assets
{
    ...
    public class MyController : MonoBehaviour
    {
        ...
        public CinemachineVirtualCamera cameratps;

        public CinemachineVirtualCamera camerafps;
        ...
        void Initialize()
        {
            ...
            gunob = GameObject.Find("SciFiRifle(Clone)");
        }
        ...
        private void Shot()
        {
            ...
            if(_input.shot) _animator.SetBool("Shot", true);
            else _animator.SetBool("Shot", false);

            AnimatorStateInfo stateInfo = _animator.GetCurrentAnimatorStateInfo(0);
            if(stateInfo.IsName("Charge")&!Charging)
            {
                Charging = true;
                gunob.GetComponent<MuzzleFlashController>().Charge();
            }
        ...
        private void CameraRotation()
        {
            ...
            if (_input.aim) camerafps.transform.RotateAround(CinemachineCameraTarget.transform.position, new Vector3(_cinemachineTargetPitch + CameraAngleOverride, _cinemachineTargetYaw, 0.0f), 1);
        ...
        private void Move()
        {
            ...
            float targetSpeed = _input.sprint && !_input.aim ? SprintSpeed : MoveSpeed;
